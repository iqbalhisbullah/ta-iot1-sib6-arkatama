    ...
    <div id="sidebar-scrollbar">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                <li class="{{ Request::is('dashboard') ? 'active' : '' }}"><a href="{{ route('dashboard') }}" class="iq-waves-effect" data-title="Dashboard"><i class="ri-home-4-line"></i><span>Dashboard</span></a></li>
