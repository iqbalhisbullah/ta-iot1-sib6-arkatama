  ...
  <section id="topbar" class="d-flex align-items-center">
    <div class="container d-flex justify-content-center justify-content-md-between">
      <div class="contact-info d-flex align-items-center">
        <i class="bi bi-envelope d-flex align-items-center"><a href="mailto:contact@example.com">iqbalhisbullah14@gmail.com</a></i>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>To fully enjoy the benefits of a connected life, it is essential to manage your devices efficiently.</p>
        </div>
